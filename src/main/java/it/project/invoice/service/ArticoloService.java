...
public class ArticoloService {
	...
	public void inserisciArticolo(ArticoloDTO dto) throws Exception {
		...
		if (!articoloRepo.existsByNome(dto.getNome())) {
			...
			throw new Exception("L'articolo " + dto.getNome() + " è già presente nel sistema");
		}
	}

	public void modificaArticolo(ArticoloUpdateDTO dto) throws Exception{
		if (articoloRepo.existsById(dto.getIdArticolo())) {
			...
			throw new Exception("L'articolo con l'id " + dto.getIdArticolo() + " non è presente nel sistema");
		}
	}

	public void eliminaArticolo(Long id) throws Exception {
		if (articoloRepo.existsById(id)) {
			...
			throw new Exception("L'articolo con l'id " + id + " non presente nel sistema");
		}
	}
